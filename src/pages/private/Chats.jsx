...
export default function ChatsPage() {
  ...
  const activeContact = contacts.find((contact) => contact.id === selectedContact) ?? contacts[0];
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 grid h-full md:grid-cols-[290px_minmax(0,1fr)]">
        <aside className="border-b border-white/10 bg-slate-950/10 p-4 md:border-b-0 md:border-r md:p-5" style={{ background: "rgba(9, 13, 22, 0.38)" }}>
                ...
                style={{
                  background:
                    selectedContact === contact.id
                      ...
                      : "rgba(10, 15, 24, 0.26)",
                  borderColor:
                    selectedContact === contact.id ? "rgba(124, 156, 255, 0.38)" : "rgba(255,255,255,0.07)",
                  boxShadow:
                    selectedContact === contact.id ? "0 12px 26px rgba(34, 53, 95, 0.2)" : "none",
                }}
              >
                <div className="relative">
                  <div
                    ...
                    style={{
                      background: "linear-gradient(135deg, #5b7cff, #2ec5ff)",
                    }}
                  >
                    {contact.avatar}
                  </div>
        ...
        <section className="flex min-h-0 flex-col">
          <header className="flex items-center justify-between border-b border-white/10 px-5 py-4" style={{ background: "rgba(9, 13, 22, 0.26)" }}>
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-base font-semibold text-white">{activeContact.name}</h3>
          ...
          <div className="border-t border-white/10 p-4 md:p-5" style={{ background: "rgba(7, 11, 18, 0.34)" }}>
